...
class BaseStreamResponse(
    ...
    Thoughts are only added to this sequence once they have been fully streamed.
    """
    ...
    def __init__(
        ...
        *,
        ...
        self._raw_content_chunks: list[dict] | None = None
    ...
    def _handle_chunk(self, chunk: AssistantContentChunk) -> AssistantContentChunk:
        ...
        if chunk.content_type == "text":
            ...
            self._handle_raw_content_chunk(chunk)
        else:
    ...
    def _handle_thought_chunk(
        ...
        if chunk.type == "thought_start_chunk":
            ...
            # Only add to content and thoughts when complete
            self._content.append(self._current_content)
    ...
    def _handle_raw_content_chunk(self, chunk: RawContentChunk) -> None:
        if self._raw_content_chunks is None:
            self._raw_content_chunks = []
            self._assistant_message.raw_content = self._raw_content_chunks
        self._raw_content_chunks.append(chunk.content)
